...
for ix in range (len(n_o_arr) - 1):
    if nix > (len(n_n_arr) - 1):
        print("Face vertice FINISH ", nix)
        break
    if n_o_arr[ix] in n_n_arr:
        continue
    else:
        rix.append(ix)
...
print(len(rix))
# print(rix)
# np.save(orignal_vertices.replace('.obj', '_traingles.obj'), rix)


####
# aa = np.loadtxt('/home/kj/DL/MoYo/Dev/Face3D/github/PRNet/Data/uv-data/triangles.txt')
# bb = np.load('/home/kj/Data/me/OBJ_PRNET/test-1_t1head-mlab_traingles.obj.npy')
